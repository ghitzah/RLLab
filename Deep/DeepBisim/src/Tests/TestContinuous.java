...
import CompGraphs.SimpleFeatureGenerator;
import CompGraphs.DeclusteringFeatureGenerator;
...
//		NewAlgoSimple s = new NewAlgoSimple(m, 100/*m.number_states()*/);
		DeclusteringFeatureGenerator s = new DeclusteringFeatureGenerator(m, 100);
